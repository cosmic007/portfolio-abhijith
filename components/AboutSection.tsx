      ...
      <div className="my-12 pb-12 md:pt-16 md:pb-48">
        ...
        <div className="flex flex-col space-y-10 items-stretch justify-center align-top md:space-x-10 md:space-y-0 md:p-4 md:flex-row md:text-left">
          <div className="md:w-1/2 ">
            ...
            <p>
              Hi, my name is Abhijith and I am a{" "}
            ...
            <br />
            <p>
            I maintain a diverse range of hobbies and passions that keep me engaged and continuously expanding my horizons. My interests encompass reading, gaming, paper crafting, and writing blogs. I am driven by a thirst for novel experiences, and I find immense joy in the process of learning and self-improvement.
            </p>
            <br />
            <p>
